  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold font-headline">Equity Margin Calculator</h1>
        ...
        <Card className="w-full max-w-lg text-center">
          ...
          <CardContent className="space-y-4">
            ...
            <CardDescription className="text-muted-foreground">
              ...
              It will help you determine the margin needed for your equity positions. Please check back later!
            </CardDescription>
          </CardContent>
        </Card>
      </div>
