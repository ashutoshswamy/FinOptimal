...
export default function StepUpSipCalculatorPage() {
  ...
  const results: StepUpSIPResult = useMemo(() => {
    return calculateStepUpSip(monthlyInvestment, investmentPeriod, returnRate, stepUpPercentage)
  }, [monthlyInvestment, investmentPeriod, returnRate, stepUpPercentage])
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-headline">Step-Up SIP Calculator</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Calculate returns with annual investment increments.</p>
        </div>
      </div>
        ...
        <Card className="lg:col-span-1 h-fit">
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    <Label htmlFor="monthly-investment">Initial Monthly Investment</Label>
                ...
                <div className="space-y-2">
                    ...
                    <Input id="step-up" value={stepUpPercentage} onChange={(e) => setStepUpPercentage(Number(e.target.value))} type="number" />
                    <Slider value={[stepUpPercentage]} onValueChange={(vals) => setStepUpPercentage(vals[0])} max={25} step={1} />
                </div>
                <div className="space-y-2">
               ...
               <Table>
                  <TableHeader>
                      <TableRow>
                          ...
                          <TableHead className="text-right">Yearly Investment</TableHead>
                  ...
                  <TableBody>
                      {results.breakdown.map((row) => (
                          <TableRow key={row.year}>
                              ...
                              <TableCell className="text-right">{formatCurrency(row.yearlyInvestment)}</TableCell>
